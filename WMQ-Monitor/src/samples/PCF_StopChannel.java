 ...
 * The sample demonstrates how PCF commands can be used to stop a channel.
 * <p>
 * The sample can bind to a local queue manager using local bindings by using the following
 * parameters:-<br>
 * PCF_StopChannel QueueManager<br>
 * <br>
 * e.g. PCF_StopChannel QM1<br>
 * <br>
 * Or the sample can bind to a remote queue manager using client bindings by using the following
 * parameters:-<br>
 * PCF_StopChannel QueueManager Host Port<br>
 * <br>
 * e.g. PCF_StopChannel QM1 localhost 1414<br>
 * <br>
...
public class PCF_StopChannel {
  ...
  public static final String sccsid = "@(#) MQMBID sn=p750-002-130627 su=_BJRU0N9vEeK1oKoKL_dPJA pn=MQJavaSamples/pcf/PCF_StopChannel.java"; //$NON-NLS-1$
  ...
  /**
   * StopChannel uses the PCF command 'MQCMD_STOP_CHANNEL' to stop a channel on the Queue Manager.
   * Mandatory PCF parameters must appear first. Failure to define these parameters first will
   * result in a 3015 (MQRCCF_PARM_SEQUENCE_ERROR) error.<br>
   * For more information on the Stop Channel command, please read the "Programmable Command Formats
   ...
   * @throws PCFException
   */
  public static void StopChannel(PCF_CommonMethods pcfCM) throws PCFException, MQDataException,
      IOException {
