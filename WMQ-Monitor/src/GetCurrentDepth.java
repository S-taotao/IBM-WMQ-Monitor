...
public class GetCurrentDepth {
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      //int openOptions = MQC.MQOO_INQUIRE;   //MQC.MQOO_INQUIRE is deprecated
      ...
      System.out.println("Current Depth of the "+ qName + " is:" + queue.getCurrentDepth());
